...
public class GetDASHStreamingSessionURLRequest extends AmazonWebServiceRequest implements
     ...
     * @see PlaybackMode
     */
    public GetDASHStreamingSessionURLRequest withPlaybackMode(PlaybackMode playbackMode) {
        this.playbackMode = playbackMode.toString();
        return this;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime
                * hashCode
                + ((getMaxManifestFragmentResults() == null) ? 0
                        : getMaxManifestFragmentResults().hashCode());
        return hashCode;
    }
